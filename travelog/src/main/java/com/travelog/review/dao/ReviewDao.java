...
public interface ReviewDao {
    ...
    @Select(value = "SELECT review_id, review_text, content_id, likes FROM review WHERE content_id = #{content_id} ORDER BY likes DESC")
    ...
    @Select(value = "SELECT a.review_id, a.review_text, a.content_id, a.likes, " +
            ...
            "WHERE a.content_id = #{content_id} AND a.userid = #{userid} " +
